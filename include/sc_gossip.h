...
// Gossip Item Text
#define GOSSIP_TEXT_BROWSE_GOODS        "Me gustaría echar un vistazo a tus suministros."
#define GOSSIP_TEXT_TRAIN               "¡Enseñame!"
...
#define GOSSIP_TEXT_INSCRIPTION         "Inscripción"
